...
namespace CentralTimeline.Repo {
    class TimelineRepository {
        ...
        public Models.Timeline GetTimeline() {
            ...
            timeline.Items.Add(new Models.TimelineItem() { Assignment = "Personal Tax", Description = "Information requested", DueDate = DateTime.Parse("31/04/2016"), Name = "Anna Copeland", AssignedToType = Models.TimelineItem.AssignedType.Practice, IsComplete = true });
            ...
            timeline.Items.Add(new Models.TimelineItem() { Assignment = "Personal Tax", Description = "Information received", DueDate = DateTime.Parse("31/06/2016"), Name = "Anna Copeland", AssignedToType = Models.TimelineItem.AssignedType.Practice });
